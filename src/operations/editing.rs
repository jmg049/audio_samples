    ...
    fn mix(
        ...
        match first.data() {
            AudioData::Mono(_) => {
                ...
                if let AudioData::Mono(result_arr) = result.data_mut() {
            ...
            AudioData::Multi(_) => {
                ...
                if let AudioData::Multi(result_arr) = result.data_mut() {
    ...
    T: StandardSample,
{
    ...
    // Add noise to signal
    match (audio.data_mut(), noise_audio.data()) {
    ...
    T: StandardSample,
{
    ...
    match shifted.into_data_borrowed() {
        AudioData::Mono(arr) => {
